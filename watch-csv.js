...
// // repo root (same as project folder)
...
//     exec("git add public", { cwd: REPO_PATH }, () => {
//       exec(
//         'git commit -m "Auto update CSV from watcher"',
//         { cwd: REPO_PATH },
//         (err) => {
//           if (err) {
...
//             else console.log("🚀 Git updated → build will start");
//           });
//         },
//       );
//     });
...
// console.log("📂 Watching CSV folders...");
// deleteTxtFiles();
